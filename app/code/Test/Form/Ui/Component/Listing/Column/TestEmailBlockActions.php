...
namespace Test\Form\Ui\Component\Listing\Column;
 ...
 */
class TestEmailBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'TestEmail';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'test_email/testemail/edit';
    private const DELETE_URL_PATH = 'test_email/testemail/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[TestEmailInterface::ENTITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [TestEmailInterface::ENTITY_ID => $item[TestEmailInterface::ENTITY_ID]];
