...
namespace Test\Form\Ui\DataProvider;
...
use Test\Form\Query\TestEmail\GetListQuery;

/**
 * DataProvider component.
 */
class TestEmailDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[TestEmailInterface::ENTITY_ID]] = $item;
        }

        if ($id = $this->request->getParam(TestEmailInterface::ENTITY_ID)) {
